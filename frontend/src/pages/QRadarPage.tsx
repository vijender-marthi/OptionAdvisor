    ...
    <div className={`bg-gray-900 rounded-2xl p-4 flex flex-col gap-3 transition-colors group
      ...
      <div className="flex gap-2 pt-1">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-cyan-900/20 hover:bg-cyan-900/30
                     text-cyan-300 text-xs font-semibold rounded-xl border border-cyan-800 hover:border-cyan-600 transition-colors"
        >
