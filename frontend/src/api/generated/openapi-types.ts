...
export type ApiSchemas = {
  ...
  readonly "DayTradeChartView": {
    ...
    readonly "patternOverlay"?: ApiSchemas["DayTradePatternOverlayView"] | null
    readonly "sigmaOverlay"?: ApiSchemas["DayTradeSigmaOverlayView"] | null
  ...
  readonly "DayTradeMarketStructureView": {
    ...
    readonly "provisionalPivot"?: ApiSchemas["DayTradeStructurePivotView"] | null
  ...
  readonly "DayTradePatternOverlayView": {
    ...
    readonly "id": string
    readonly "label": string
    readonly "segments"?: Array<ApiSchemas["DayTradePatternSegmentView"]>
    readonly "status": string
  ...
  readonly "DayTradePatternSegmentView": {
  ...
  readonly "DayTradeSigmaOverlayView": {
    readonly "affectsTradeFocusScale": boolean
    readonly "anchorPolicy": string
    readonly "exchangeTimeZone": string
    readonly "id": string
    readonly "label": string
    readonly "points"?: Array<ApiSchemas["DayTradeSigmaPointView"]>
    readonly "sessionDate": string
    readonly "visibleByDefault": boolean
  }
  readonly "DayTradeSigmaPointView": {
    readonly "barStartUtc": string
    readonly "minusOne"?: number | null
    readonly "minusTwo"?: number | null
    readonly "plusOne"?: number | null
    readonly "plusTwo"?: number | null
